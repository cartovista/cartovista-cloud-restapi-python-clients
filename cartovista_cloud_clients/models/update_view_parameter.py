...
class UpdateViewParameter(object):
    ...
    def __init__(self, title=None, permissions=None):  # noqa: E501
        """UpdateViewParameter - a model defined in Swagger"""  # noqa: E501
        self._title = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateViewParameter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateViewParameter):
            return False
