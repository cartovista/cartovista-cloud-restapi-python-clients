...
class DataTableApi(object):
    ...
    def data_table_geocode_data_table_synchronous(self, body, data_table_identifier, tenant_url_code, **kwargs):  # noqa: E501
        """Converts a table to a point by building addresses using the list of columns.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_table_geocode_data_table_synchronous(body, data_table_identifier, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.data_table_geocode_data_table_synchronous_with_http_info(body, data_table_identifier, tenant_url_code, **kwargs)  # noqa: E501
        else:
            (data) = self.data_table_geocode_data_table_synchronous_with_http_info(body, data_table_identifier, tenant_url_code, **kwargs)  # noqa: E501
            return data

    def data_table_geocode_data_table_synchronous_with_http_info(self, body, data_table_identifier, tenant_url_code, **kwargs):  # noqa: E501
        """Converts a table to a point by building addresses using the list of columns.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_table_geocode_data_table_synchronous_with_http_info(body, data_table_identifier, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method data_table_geocode_data_table_synchronous" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `data_table_geocode_data_table_synchronous`")  # noqa: E501
        # verify the required parameter 'data_table_identifier' is set
        if ('data_table_identifier' not in params or
                params['data_table_identifier'] is None):
            raise ValueError("Missing the required parameter `data_table_identifier` when calling `data_table_geocode_data_table_synchronous`")  # noqa: E501
        # verify the required parameter 'tenant_url_code' is set
        if ('tenant_url_code' not in params or
                params['tenant_url_code'] is None):
            raise ValueError("Missing the required parameter `tenant_url_code` when calling `data_table_geocode_data_table_synchronous`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{tenantUrlCode}/api/v2/DataTable/{dataTableIdentifier}/geocode-synchronous', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def data_table_georeference_data_table_synchronous(self, body, data_table_identifier, tenant_url_code, **kwargs):  # noqa: E501
        """Converts a table to a point layer using two of its columns as latitude and longitude.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_table_georeference_data_table_synchronous(body, data_table_identifier, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.data_table_georeference_data_table_synchronous_with_http_info(body, data_table_identifier, tenant_url_code, **kwargs)  # noqa: E501
        else:
            (data) = self.data_table_georeference_data_table_synchronous_with_http_info(body, data_table_identifier, tenant_url_code, **kwargs)  # noqa: E501
            return data

    def data_table_georeference_data_table_synchronous_with_http_info(self, body, data_table_identifier, tenant_url_code, **kwargs):  # noqa: E501
        """Converts a table to a point layer using two of its columns as latitude and longitude.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.data_table_georeference_data_table_synchronous_with_http_info(body, data_table_identifier, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method data_table_georeference_data_table_synchronous" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `data_table_georeference_data_table_synchronous`")  # noqa: E501
        # verify the required parameter 'data_table_identifier' is set
        if ('data_table_identifier' not in params or
                params['data_table_identifier'] is None):
            raise ValueError("Missing the required parameter `data_table_identifier` when calling `data_table_georeference_data_table_synchronous`")  # noqa: E501
        # verify the required parameter 'tenant_url_code' is set
        if ('tenant_url_code' not in params or
                params['tenant_url_code'] is None):
            raise ValueError("Missing the required parameter `tenant_url_code` when calling `data_table_georeference_data_table_synchronous`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{tenantUrlCode}/api/v2/DataTable/{dataTableIdentifier}/georeference-synchronous', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
