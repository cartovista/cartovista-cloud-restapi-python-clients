...
class SlideApi(object):
    ...
    def slide_update_slide_story(self, body, slide_id, tenant_url_code, **kwargs):  # noqa: E501
        """Updates the slide's story.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.slide_update_slide_story(body, slide_id, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.slide_update_slide_story_with_http_info(body, slide_id, tenant_url_code, **kwargs)  # noqa: E501
        else:
            (data) = self.slide_update_slide_story_with_http_info(body, slide_id, tenant_url_code, **kwargs)  # noqa: E501
            return data

    def slide_update_slide_story_with_http_info(self, body, slide_id, tenant_url_code, **kwargs):  # noqa: E501
        """Updates the slide's story.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.slide_update_slide_story_with_http_info(body, slide_id, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method slide_update_slide_story" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `slide_update_slide_story`")  # noqa: E501
        # verify the required parameter 'slide_id' is set
        if ('slide_id' not in params or
                params['slide_id'] is None):
            raise ValueError("Missing the required parameter `slide_id` when calling `slide_update_slide_story`")  # noqa: E501
        # verify the required parameter 'tenant_url_code' is set
        if ('tenant_url_code' not in params or
                params['tenant_url_code'] is None):
            raise ValueError("Missing the required parameter `tenant_url_code` when calling `slide_update_slide_story`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/{tenantUrlCode}/api/v2/slides/{slideId}/story', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
