...
class MapApi(object):
    ...
    def map_get_map_for_viewer(self, map_identifier, v9, tenant_url_code, **kwargs):  # noqa: E501
        """Gets all the data required to open a map.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.map_get_map_for_viewer(map_identifier, v9, tenant_url_code, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str map_identifier: (required)
        :param bool v9: (required)
        :param str tenant_url_code: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.map_get_map_for_viewer_with_http_info(map_identifier, v9, tenant_url_code, **kwargs)  # noqa: E501
        else:
            (data) = self.map_get_map_for_viewer_with_http_info(map_identifier, v9, tenant_url_code, **kwargs)  # noqa: E501
            return data

    def map_get_map_for_viewer_with_http_info(self, map_identifier, v9, tenant_url_code, **kwargs):  # noqa: E501
        """Gets all the data required to open a map.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.map_get_map_for_viewer_with_http_info(map_identifier, v9, tenant_url_code, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['map_identifier', 'v9', 'tenant_url_code']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'v9' is set
        if ('v9' not in params or
                params['v9'] is None):
            raise ValueError("Missing the required parameter `v9` when calling `map_get_map_for_viewer`")  # noqa: E501
        # verify the required parameter 'tenant_url_code' is set
        if ('tenant_url_code' not in params or
                params['tenant_url_code'] is None):
        ...
        query_params = []
        if 'v9' in params:
            query_params.append(('v9', params['v9']))  # noqa: E501
